...
CREATE TABLE public.class_subjects ( 
	...
	CONSTRAINT unq_class_subjects_class_id UNIQUE ( class_id ) ,
	CONSTRAINT unq_class_subjects_subject_id UNIQUE ( subject_id ) 
 );
...
CREATE TABLE public.permissions_role ( 
	...
	CONSTRAINT unq_permissions_role_permission_id UNIQUE ( permission_id ) ,
	CONSTRAINT unq_permissions_role_role_id UNIQUE ( role_id ) 
 );
...
CREATE TABLE public.school_users_roles ( 
	id                   serial  NOT NULL,
	school_users_id      integer  ,
	role_id              integer  ,
	CONSTRAINT pk_school_users_roles_id PRIMARY KEY ( id ),
	CONSTRAINT unq_school_users_roles_school_users_id UNIQUE ( school_users_id ) ,
	CONSTRAINT unq_school_users_roles_role_id UNIQUE ( role_id ) 
 );
...
CREATE TABLE public.schools ( 
	...
	CONSTRAINT idx_schools_cluster_id UNIQUE ( cluster_id ) 
 );

CREATE INDEX idx_schools_school_type_id ON public.schools ( school_type_id );

CREATE INDEX idx_schools_pincode_id ON public.schools ( pincode_id );
...
CREATE TABLE public.payement_details ( 
	...
	invoices_no          varchar(100)  NOT NULL,
...
CREATE INDEX idx_school_user_school_id ON public.school_users ( school_id );

CREATE INDEX idx_school_user_role_id ON public.school_users ( role_id );

CREATE INDEX idx_school_user_designation_id ON public.school_users ( designation_id );
...
ALTER TABLE public.classes ADD CONSTRAINT fk_classes_class_subjects FOREIGN KEY ( id ) REFERENCES public.class_subjects( class_id );
...
ALTER TABLE public.resource_type ADD CONSTRAINT fk_resource_type_resources FOREIGN KEY ( id ) REFERENCES public.resources( type_id );

ALTER TABLE public.resources ADD CONSTRAINT fk_resources_units FOREIGN KEY ( unit_id ) REFERENCES public.units( id );

ALTER TABLE public.roles ADD CONSTRAINT fk_roles_user_role FOREIGN KEY ( id ) REFERENCES public.user_role( role_id );

ALTER TABLE public.roles ADD CONSTRAINT fk_roles_permissions_role FOREIGN KEY ( id ) REFERENCES public.permissions_role( role_id );

ALTER TABLE public.roles ADD CONSTRAINT fk_roles_school_users_roles FOREIGN KEY ( id ) REFERENCES public.school_users_roles( role_id );
...
ALTER TABLE public.school_users ADD CONSTRAINT fk_school_users_school_users_roles FOREIGN KEY ( id ) REFERENCES public.school_users_roles( school_users_id );
...
ALTER TABLE public.schools ADD CONSTRAINT fk_schools_pincode FOREIGN KEY ( pincode_id ) REFERENCES public.pincode( id );
...
ALTER TABLE public.subjects ADD CONSTRAINT fk_subjects_class_subjects FOREIGN KEY ( id ) REFERENCES public.class_subjects( subject_id );
